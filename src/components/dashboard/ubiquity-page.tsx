...
export function UbiquityPage() {
  ...
  const [botMessage, setBotMessage] = useState("@Logicra summarize this chat thread");
  const [botReply, setBotReply] = useState("");
  const [command, setCommand] = useState("");
  const [commandOutput, setCommandOutput] = useState("");
  const [pageTitle, setPageTitle] = useState("Logicra dashboard");
    ...
    <main className="min-h-svh bg-[linear-gradient(180deg,#020617_0%,#111827_100%)] p-4 text-slate-100 md:p-8">
      <div className="mx-auto w-full max-w-7xl space-y-4">
        <Card className="border-slate-700/70 bg-slate-950/80">
          <CardHeader>
            <CardTitle>Logicra Everywhere</CardTitle>
            <CardDescription className="text-slate-400">
              Entry points across browser, desktop, IDE, and team chat so users can trigger Logicra anywhere.
            </CardDescription>
          </CardHeader>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <Card className="border-slate-700/70 bg-slate-950/80">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Highlight text on any site and send it to Logicra for analysis.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2 text-sm text-slate-300">
              ...
              <p>Context-menu action: &quot;Send to Logicra&quot;.</p>
            </CardContent>
          </Card>
